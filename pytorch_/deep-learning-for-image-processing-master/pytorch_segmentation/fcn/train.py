...
class SegmentationPresetTrain:#数据增强
...
def main(args):
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               shuffle=True,
                                               pin_memory=True,
                                               collate_fn=train_dataset.collate_fn#将该批次所有的数据中填充到批次的最大尺寸
                                               )
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="D:\Pascal_dataset", help="VOCdevkit root")
